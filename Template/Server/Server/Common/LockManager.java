				...
				synchronized (this.lockTable) {
					...
					if (!bConflict) {
						...
						if (bConvert.get(0) == true) {
							...
							TransactionLockObject xLockOld = (TransactionLockObject)xLockObject.clone();
							xLockOld.setLockType(TransactionLockObject.LockType.LOCK_READ);
							DataLockObject dataLockOld = (DataLockObject)dataLockObject.clone();
							dataLockOld.setLockType(TransactionLockObject.LockType.LOCK_READ);
							this.lockTable.remove(xLockOld);
							this.lockTable.remove(dataLockOld);
