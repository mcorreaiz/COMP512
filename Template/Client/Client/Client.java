...
public abstract class Client
{
	...
	{
		// We need to define a protocol. For now, "+func+arg1+arg2+...+argn+"
		String input = "+";
		for (String s: arguments) {
			input += s + "+";
		}
		try {
			PrintWriter out = new PrintWriter(m_resourceManager.socket.getOutputStream(), true);
			out.println(input); // Send msg
			out.flush();
		}
		catch (IOException e){
			System.err.println((char)27 + "[31;1mCommand exception: " + (char)27 + "[0mUncaught exception");
...
>>>>>>> middleware
		...
		// I would move all the switch statement to the middleware. Except for the Help and Quit handlers.
